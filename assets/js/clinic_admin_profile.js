document.addEventListener("DOMContentLoaded", () => {
  const editBtn = document.getElementById("editAdminInfo");
  const form = document.querySelector(".admin-info-form");
  ...
  editBtn.addEventListener("click", () => {
    ...
    if (!isEditing) {
      ...
      fetch("/BumbleCare/handlers/update_clinic_admin_info.php", {
        method: "POST",
        body: formData
      })
        .then(res => res.json())
