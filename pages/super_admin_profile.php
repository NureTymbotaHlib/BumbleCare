...
<main class="super-admin-profile">
  <div class="bc-container profile-wrapper">
    ...
    <div class="profile-header">
      <div class="profile-photo">
        ...
        <div class="profile-info">
          ...
          <p class="profile-detail">Супер адміністратор</p>
        </div>
      </div>
    ...
    <form class="super-admin-info-form">
      <div class="form-grid">
      ...
      <button type="button" class="btn blue" id="editSuperAdminInfo">Редагувати</button>
    </form>
...
<script src="/BumbleCare/assets/js/super_admin_profile.js"></script>
